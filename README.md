...
-	[Convert Word to Markdown](https://help.syncfusion.com/document-processing/word/conversions/word-to-markdown-conversion#convert-word-to-markdown) - Convert Word document to Markdown 
-	[Save images as separate files](https://help.syncfusion.com/document-processing/word/conversions/word-to-markdown-conversion#customize-image-saving) - Save images as separate files during Word to Markdown conversion.
-	[Convert Markdown to Word](https://help.syncfusion.com/document-processing/word/conversions/markdown-to-word-conversion) - Convert Markdown to Word document 
-	[Customize image data](https://help.syncfusion.com/document-processing/word/conversions/markdown-to-word-conversion#customize-image-data) - Customize image data while importing Markdown
...
*   **Documentation:** [Convert Word document to Markdown using Syncfusion&reg; Word Library](https://help.syncfusion.com/document-processing/word/conversions/word-to-markdown-conversion)
